...
#session = get_active_session() ==> only applies for SIS, replaced by the next 2 lines for SNIS
...
#st.stop() # we add this stop command to focus on this section
...
if ingredients_list : # this means if the list is not empty
